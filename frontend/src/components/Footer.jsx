...
const Footer = () => {
  return (
    <footer className="bg-white">
      {/* Top Footer Bar */}
      <div className="bg-rose-50 border-t border-rose-100 py-6 sm:py-8">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 md:gap-8 text-center">
            <div>
              <div className="text-xl sm:text-2xl mb-2">🚚</div>
              <h3 className="font-semibold text-sm sm:text-base text-gray-900 mb-1">Free Shipping</h3>
              <p className="text-xs sm:text-sm text-gray-600">On orders over $100</p>
            </div>
            <div>
              <div className="text-xl sm:text-2xl mb-2">↩️</div>
              <h3 className="font-semibold text-sm sm:text-base text-gray-900 mb-1">15 Days Return</h3>
              <p className="text-xs sm:text-sm text-gray-600">Easy returns</p>
            </div>
            <div>
              <div className="text-xl sm:text-2xl mb-2">💬</div>
              <h3 className="font-semibold text-sm sm:text-base text-gray-900 mb-1">Customer Support</h3>
              <p className="text-xs sm:text-sm text-gray-600">24/7 assistance</p>
            </div>
            <div>
              <div className="text-xl sm:text-2xl mb-2">🔒</div>
              <h3 className="font-semibold text-sm sm:text-base text-gray-900 mb-1">Secure Payment</h3>
              <p className="text-xs sm:text-sm text-gray-600">Protected transactions</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 sm:px-6 py-8 sm:py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
          ...
          <div className="text-center sm:text-left">
            <h3 className="font-serif text-lg sm:text-xl font-semibold mb-3 sm:mb-4">GET IN TOUCH</h3>
            <p className="text-sm sm:text-base text-gray-600 break-words">info@aldoradojewells.com</p>
          </div>
          ...
          {/* Social Media */}
          <div className="text-center sm:text-left">
            <h3 className="font-serif text-lg sm:text-xl font-semibold mb-3 sm:mb-4">SOCIAL MEDIA</h3>
      ...
      {/* Bottom Footer Bar */}
      <div className="bg-rose-50 border-t border-rose-100 py-4 sm:py-6">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-3 sm:gap-4">
            <div className="text-xs sm:text-sm text-gray-600 text-center md:text-left order-3 md:order-1">© 2023 Aldorado Jewells. All rights reserved.</div>
            <div className="text-xl sm:text-2xl font-serif font-bold text-gray-900 order-1 md:order-2">Aldorado Jewells</div>
            <div className="flex flex-col sm:flex-row items-center gap-3 sm:gap-6 order-2 md:order-3">
              <div className="flex flex-wrap gap-2 sm:gap-4 text-xs sm:text-sm justify-center">
