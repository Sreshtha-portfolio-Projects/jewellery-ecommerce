      ...
      <div className="max-w-md w-full bg-white rounded-lg shadow-lg p-8">
        ...
        <div className="mt-4">
          ...
          <button
            ...
            disabled={loading || googleLoading}
            className="mt-4 w-full py-3 border-2 border-gray-300 rounded-lg hover:border-rose-500 transition-colors font-medium disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-3"
          >
            {googleLoading ? (
              'Connecting...'
            ) : (
        ...
        <div className="mt-6 text-center space-y-2">
          <Link
            to="/forgot-password"
            className="text-sm text-rose-600 hover:text-rose-700 font-medium block"
          >
            Forgot password?
          </Link>
